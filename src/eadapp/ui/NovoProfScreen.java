 ...
 * @author jb_gr
 */
public class NovoProfScreen extends javax.swing.JFrame {

    /**
     * Creates new form NovoProfScreen
     */
    public NovoProfScreen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("TELA DE NOVO PROFESSOR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoProfScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoProfScreen().setVisible(true);
            }
        });
    }
