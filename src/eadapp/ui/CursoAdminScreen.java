 ...
 * @author jb_gr
 */
public class CursoAdminScreen extends javax.swing.JFrame {

    /**
     * Creates new form CursoAdminScreen
     */
    public CursoAdminScreen() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CursoAdminScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CursoAdminScreen().setVisible(true);
            }
        });
    }
